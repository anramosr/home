...
<li><a href="JMP_AndreyRamos.pdf" target="_blank">Quantitative Analysis of Climate Heterogeneity via an Unconditional Quantile Vector Error Correction Model</a>.</li>  
<p></p>
